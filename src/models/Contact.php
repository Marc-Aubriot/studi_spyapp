...
class Contact
{
    ...
    private function addContactToDatabase() {
        // Connexion à la base de données
        $conn = new PDO("mysql:host=". DB_HOST .";dbname=". DB_NAME, DB_USERNAME, DB_PASSWORD);

        // Préparation de la requête
        $stmt = $conn->prepare('INSERT INTO contact (code_identification, nom, prénom, date_de_naissance, nationalite) VALUES (:code_identification, :nom, :prénom, :date_de_naissance, :nationalité)');
